      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-center">
          <div
            ...
            data-aos-once="true"
          >
            <h2 className="text-3xl py-2 md:text-4xl lg:text-5xl font-bold text-base-content">
              Playbooks adapted to <span className="text-primary">your goals</span>
            </h2>
            <div className="relative flex flex-col gap-6">
              <div className="flex flex-col gap-1">
                <div className="bg-primary text-primary-content px-3 py-1.5 font-bold text-base lg:text-lg rounded-sm">
                  Portfolio income approach
                </div>
                <p className="text-base lg:text-lg font-bold text-base-content mt-1">Build top-up income</p>
              ...
              <div className="flex flex-col gap-1 self-center">
                ...
                <p className="text-base lg:text-lg font-bold text-base-content mt-1">Build base portfolio + Top-up income</p>
                <p className="text-base lg:text-lg text-primary">
